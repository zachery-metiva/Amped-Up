...
_POLE_DETAILS: dict[str, PoleDetail] = {
    "P-1147": PoleDetail(
        ...
        severity=Severity.CRITICAL,
        address="Elm St & 7th Ave",
        lat=40.7589,
        lon=-73.9851,
        height="45 ft (above grade 38 ft)",
        owner="ConEd · Joint use with Verizon",
    ...
    "P-1147": PoleHistory(
        ...
        events=[
            ...
            HistoryEvent(
                ...
                description=None,
                comment="De-energize feeder F-407 before approach. Verizon fiber attached at 23 ft, coordinate with their NOC ticket 88421.",
                severity=None,
                pin_color="#475569",
            ),
            HistoryEvent(
            ...
            HistoryEvent(
                ...
                date="2019-03-04",
                author=None,
                description="Verizon fiber attachment permitted at 23 ft above grade.",
                comment=None,
                severity=None,
                pin_color="#60A5FA",
            ),
...
_MAP_POLES: list[MapPole] = [
    MapPole(id="P-1147", severity=Severity.CRITICAL, lat=40.7589, lon=-73.9851),
    MapPole(id="P-1192", severity=Severity.CRITICAL, lat=40.7575, lon=-73.9882),
    MapPole(id="P-1062", severity=Severity.HIGH, lat=40.7612, lon=-73.9820),
    MapPole(id="P-1078", severity=Severity.HIGH, lat=40.7598, lon=-73.9863),
    MapPole(id="P-1023", severity=Severity.MEDIUM, lat=40.7601, lon=-73.9905),
    MapPole(id="P-1131", severity=Severity.MEDIUM, lat=40.7567, lon=-73.9871),
    MapPole(id="P-1001", severity=Severity.LOW, lat=40.7620, lon=-73.9910),
    MapPole(id="P-1002", severity=Severity.LOW, lat=40.7635, lon=-73.9850),
    MapPole(id="P-1003", severity=Severity.LOW, lat=40.7590, lon=-73.9830),
    MapPole(id="P-1004", severity=Severity.LOW, lat=40.7580, lon=-73.9895),
    MapPole(id="P-1005", severity=Severity.MEDIUM, lat=40.7608, lon=-73.9840),
    MapPole(id="P-1006", severity=Severity.LOW, lat=40.7555, lon=-73.9855),
    MapPole(id="P-1007", severity=Severity.LOW, lat=40.7642, lon=-73.9870),
    MapPole(id="P-1008", severity=Severity.LOW, lat=40.7560, lon=-73.9820),
    MapPole(id="P-1009", severity=Severity.LOW, lat=40.7625, lon=-73.9900),
]
